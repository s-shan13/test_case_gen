    ...
    <div className='caseBody'>
      ...
      <div className='inputSection'>
        <div className='eachInput'>
          <label for='minSize'>Enter minimum number of strings to generate</label>
          <input type='text' placeholder='Min number of values' name='minSize' />
        </div>
        <div className='eachInput'>
          <label for='maxSize'>Enter maximum number of strings to generate</label>
          <input type='text' placeholder='Max number of values' name='maxSize' />
        </div>
        <div className='eachInput'>
          <label for='minVal'>Enter minimum length of string</label>
          <input type='text' placeholder='Min integer value' name='minVal' />
        </div>
        <div className='eachInput'>
          <label for='maxVal'>Enter maximum length of string</label>
